/**
 * This script receives form data from 'src/views/signup.php', makes a POST request to SignUpController, which will verify if the posted data is available
 * to use, and return a response in JSON to that.
 */
...
let span_username = document.getElementById("username-feedback");
...
async function verifyAvailability(field, value) {
  ...
  try {
    const response = await fetch('/../../../src/controllers/SignUpController.php', requestInit)
